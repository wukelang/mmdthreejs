...
//#define AnimatedTexture "gi1f.gif" //GIF or APNG (Optional, delete the double slash at the beginning of the line to enable it)
...
//#define SpecularMapTexture  "tex_BG_N_lightmap_01.png" //Specular Map (Optional, delete the double slash at the beginning of the line to enable it)
...
#define SUBMAP 1 //Enable or disable submap, model will turn black (or has messed up UV) if it don't have submap UV (or if you choose the wrong AddUV )

	#define SubMapTexture "tex_BG_N_lightmap_01.png" //Optional when you disable submap, add double slash at the beginning of the line in case you don't have a submap to put in
